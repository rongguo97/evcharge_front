  ...
  useEffect(() => {
    ...
    const timer = setInterval(() => {
      ...
      if (diff > 0) {
        ...
        setTimeLeft(
          `+ ${overMins < 10 ? "0" + overMins : overMins}:${overSecs < 10 ? "0" + overSecs : overSecs}`,
        );
        setIsOverdue(true);
      }
    }, 1000);
      ...
      <div className="main-layout">
        <section className="hero-banner">
          ...
          <div className="hero-content">
            ...
            <p>
              {user?.memberName || "사용자"}님, 환영합니다. 충전 준비가
              완료되었습니다.
            </p>
          </div>
        </section>
        ...
        <div className="dashboard-grid">
          <div className="status-panel">
            ...
            <div className="glass-card">
              <span>충전 제어</span>
              {!reservation ? (
                <div className="no-res" style={{ marginTop: "15px" }}>
                  진행 중인 예약이 없습니다.
                </div>
              ) : (
                <div
                  className="charging-control"
                ...
                >
                  ...
                  >
                    ...
                    <p
                      style={{ margin: "0", color: "#aaa", fontSize: "0.9rem" }}
                    >
                      예약 시간: {formatTime(reservation.startTime)} ~{" "}
